...
public class wrong_Search_Neg extends SetUp {
    @Test
    public void feeds_addCheek() throws InterruptedException {
...
//        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@type='password']"))).sendKeys("Arpon@123456");
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.tagName("input"))).sendKeys("Learning");
        Thread.sleep(5000);
